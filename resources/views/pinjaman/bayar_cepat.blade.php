...
@section('content')
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globes">Percepatan Pelunasan</i> 
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="{{ route('pinjaman.print.cepat', ['id' => $id_pinjaman]) }}" target="_blank" class="btn btn-default"><i class="fa fa-print"></i>  Cetak</a>
          <a type="button" href="{{ route('pinjaman.konfirmasi.cepat', ['id' => $id_pinjaman]) }}" class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Bayar Angsuran
          </a>
        </div>
      </div>
    </section>
